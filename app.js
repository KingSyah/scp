...
/** Format array warna untuk EVE Online: "#00FF0A,#C000FF,#261E1E,#F2FF00" */
function formatEveOnline(hexArray) {
  return hexArray.map(h => h.toUpperCase()).join(',');
}
...
function renderExportCode() {
  ...
  switch (currentExportFormat) {
    ...
    case 'json':
      ...
      break;
    case 'eve':
      code = formatEveOnline(c) + '\n\n// Paste langsung ke EVE Online MOTD / Fleet Ping\n// Contoh: <font size="14" color="' + c[0].toUpperCase() + '">Teks</font>';
      break;
    case 'png':
